...
public struct CAPSULE
{
    ...
    public CAPSULE(Vector3 center, float halfLen, float radius, Quaternion rot)
    {
        mCenter = center;
        mRadius = radius;
        p0 = mCenter + rot * new Vector3(0, halfLen, 0);
        p1 = mCenter + rot * new Vector3(0, -halfLen, 0);
    }

    public void Init(Vector3 center, float halfLen, float radius, Quaternion rot)
    {
        mCenter = center;
        mRadius = radius;
        p0 = mCenter + rot * new Vector3(0, halfLen, 0);
